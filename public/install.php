...
if (!$errInfo && isset($_SERVER['REQUEST_METHOD']) && $_SERVER['REQUEST_METHOD'] == 'POST')
{
    ...
    $mysqlPassword = isset($_POST['mysqlPassword']) ? $_POST['mysqlPassword'] : '123456';
    ...
    try
    {
       ...
       /* echo  "UPDATE {$mysqlPrefix}admin_user SET account = '{$adminUsername}',password = '{$newPassword}',clear_password='{$clearPassword}' WHERE id = 1";*/
                       ...
                       <h4>Yamecent-admin 安装</h4>
                        ...
                        <form class="pt-3">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control form-control-lg" name="mysqlHost" placeholder="Mysql 数据库地址" value="172.17.0.3">
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control form-control-lg" name="mysqlDatabase" placeholder="Mysql 数据库名" value="yamecent-admin">
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control form-control-lg" name="mysqlUsername" placeholder="Mysql 用户名"  value="root">
                            </div>
                            <div class="form-group">
                                <input type="password" class="form-control form-control-lg" name="mysqlPassword" placeholder="Mysql 密码" value="123456">
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control form-control-lg" name="mysqlPrefix" placeholder="Mysql 表前缀 例：ya_" value="v_">
                            </div>
                            <br>
                            <br>
                            <div class="form-group">
                                <input type="text" class="form-control form-control-lg" name="adminUsername" placeholder="管理员用户名" value="admin">
                            </div>
                            <div class="form-group">
                                <input type="password" class="form-control form-control-lg" name="adminPassword" placeholder="管理员密码" value="123456">
                            </div>
                            <div class="form-group">
                                <input type="password" class="form-control form-control-lg" name="adminPasswordAgain" placeholder="管理员确认密码" value="123456">
                            </div>
